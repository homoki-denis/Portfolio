...
//   return (
//   <div>
//    <Tab1 className={location === '/home' && "active"}/>
//   </div>
//   );
// }
        ...
        <Link to="/github">
          <div className="sidebar-container">
            <svg
              ...
              fill="rgb(106, 115, 125)"
              className={`sidebar-icon ${
                location.pathname === "/github" && "sidebar-active"
              }`}
            >
        ...
        <Link to="/projects">
          <div className="sidebar-container">
            <svg
              ...
              fill="rgb(106, 115, 125)"
              className={`sidebar-icon ${
                location.pathname === "/projects" && "sidebar-active"
              }`}
            >
        ...
        <Link to="/articles">
          <div className="sidebar-container">
            <svg
              ...
              fill="rgb(106, 115, 125)"
              className={`sidebar-icon ${
                location.pathname === "/articles" && "sidebar-active"
              }`}
            >
        ...
        <Link to="/contact">
          <div className="sidebar-container">
            <svg
              ...
              fill="rgb(106, 115, 125)"
              className={`sidebar-icon ${
                location.pathname === "/contact" && "sidebar-active"
              }`}
            >
              <path
                fill-rule="evenodd"
        ...
        <Link to="/about">
          <div className="sidebar-container">
            <svg
              ...
              fill="rgb(106, 115, 125)"
              className={`sidebar-icon ${
                location.pathname === "/about" && "sidebar-active"
              }`}
            >
